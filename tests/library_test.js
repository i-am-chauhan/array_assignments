...
const average=require('../array_lib.js').average;
const countEvens=require('../array_lib.js').countEvens;
const countOdds=require('../array_lib.js').countOdds;
const lib=require('../array_lib.js');
const {difference}=require('../array_lib.js');
const {extractDigits}=require('../array_lib.js');
const greatestNumber=require('../array_lib.js').greatestNumber;
const indexOfValue=require('../array_lib.js').indexOfValue;
const {intersection}=require('../array_lib.js');
const isAscending=require('../array_lib.js').isAscending;
const isDescending=require('../array_lib.js').isDescending;
const {isSubset}=require('../array_lib.js');
const mapLength=require('../array_lib.js').mapLength;
const {partition}=require('../array_lib.js');
const result=require('../array_lib.js').reverseFibonacci;
const reverse=require('../array_lib.js').reverse;
const {rotate}=require('../array_lib.js');
const evenIndexNumbers=require('../array_lib.js').selectEvenIndexValues;
const listOfEvenNumbers=require('../array_lib.js').listOfEvenNumbers;
const selectOddNumbers=require('../array_lib.js').selectOddNumbers;
const smallestNumber=require('../array_lib.js').getSmallestNumber;
const sumOfElements=require('../array_lib.js').sumOfElements;
const {union}=require('../array_lib.js');
const {unique}=require('../array_lib.js')
const {zip}=require('../array_lib.js');
